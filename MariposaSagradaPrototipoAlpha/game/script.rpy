...
label start:
    ...
    menu:
        "Elige el género de tu mariposa."
        "Hembra":
        ...
        "Macho":
            play sound "audio/sonido/clic.mp3"
            $ genero = False
            $ texto = "Las mariposas machos tienen dos puntitos en las alas, a diferencia de las mariposas hembras que no los tienen."
...
label nombre_usuario:
    $ usuario = renpy.input("Ingresa el nombre que le daras a tu mariposa")
...
label escena_0:
    ...
    narr "Al ser la primera en salir batió sus alas suavemente y se acercó a ellas mostrándoles cómo debían extender sus
...
label comer_campo:
    ...
    narr "Vacilante [usuario] se posó sobre un arbusto aún dudosa de comer."
    ...
    narr "Tan pronto como bebieron el néctar cayeron al suelo en un profundo sueño del que jamás despertarán."
    ...
    narr "Dolida por sus compañeras muertas, [usuario] aleteo lejos de ese campo y su bestia de metal, con las sobrevivientes
    a sus espaldas."
...
label hablar_abeja:
    ...
    narr """[usuario] la volteo a ver con ojos agotados y un rugido de su panza sonó en medio del silencio.
...
label escena_8:
    ...
    Así que, [usuario] se preguntó si partir ahora, antes de que el frío las alcanzará o quedarse más tiempo en la comodidad que
...
label escena_quedarse:
    ...
    narr "[usuario] decidió permanecer unos más días en aquella granja junto con sus compañeras, sin embargo..."
    ...
    play sound "audio/sonido/gallina.mp3" volume 0.25
    gall """Hace mucho tiempo tu especie migraba en octubre porque frío tardaba en llegar, pero de un tiempo para acá.
    ...
    narr "[usuario] levantó la cabeza con emoción y cuando miro los primeros rayos del sol colándose por el granero se despidió
    de la gallina y les indico a sus compañeras que era hora de partir."
    ...
    [usuario] con dolor se disculpó por no haber partido antes y sin volver a mirar a sus compañeras pérdidas voló junto a las
...
label escena_10:
    ...
    Pues toda las mañana el sol brilló en el cielo despejado, sin mencionar que no era época de lluvia."""
...
label escena_ArbolSinHojas:
    ...
    Con las alas mojadas y el frío pasando entre ellas, se les entumeció el cuerpo provocando que cayeran del árbol."""
...
label escena_12:
    ...
    Sin embargo, el suelo de México era muy diferente al Estados Unidos o Canadá, pues grandes montañas rocosas se esparcían por
    ...
    $ texto = "Esquiva los autos para sobrevivir."
    play sound "audio/sonido/papel.mp3"
    show screen pistas_info
    pause 2.0
    hide screen pistas_info
...
label auto_1:
    ...
    $ rango_tiempo = 5
    $ etiqueta = "timeout_1"
    show screen contador

    menu:
        "Izquierda":
            play sound "audio/sonido/clic.mp3"
            hide screen contador
            $ num_mari -= 10
            $ menos_mari += 10
            jump auto_2
        "Derecha":
...
label escena_14:
    ...
    Eran bosques densos en donde se protegerian de los vientos y de los cambios abruptos de temperatura y humedad, ideales para
...
label irse_aguacates:
    narr "Cómo ese extraño bosque no era apto para hibernar, [usuario] decidió que lo mejor era seguir volando."
...
label escena_17:
    ...
    narr """Más allá de la pila de árboles se encontraban los restos de lo había sido un bosque.
...
label escena_19:
    ...
    majestuosas arboles frente a ellas
...
label escena_22:
    ...
    play music "audio/musica/musica_piano.mp3" loop fadein 4.0
    narr """En la entrada bosque había un ancho camino y unos pocos más se ramificaban de este en diferentes
    direcciones desvaneciéndose a lo lejos.
...
label escena_24:
    ...
    reproduciría para crear descendencia."""
...
label final_malo_2:
    $ texto = "La mayoria de las mariposas a tu cuidado murieron."
...
label final_bueno:
    ...
    narr "En donde, después de 9 meses de vida y habiendo recorrido aproximadamente 5000k."
