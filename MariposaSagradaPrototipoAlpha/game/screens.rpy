...
screen navigation():
    if main_menu:
        fixed:
            ...
            imagebutton auto "gui/mis_botones/nuevo_juego_%s.png" xpos 48 ypos 664 focus_mask True action Start() hovered [Play("sound", "audio/sonido/clic.mp3")]

            imagebutton auto "gui/mis_botones/cargar_%s.png" xpos 48 ypos 713 focus_mask True action ShowMenu("load") hovered [Play("sound", "audio/sonido/clic.mp3")]

            imagebutton auto "gui/mis_botones/opciones_%s.png" xpos 48 ypos 755 focus_mask True action ShowMenu("preferences") hovered [Play("sound", "audio/sonido/clic.mp3")]

            if _in_replay:
                textbutton _("End Replay") action EndReplay(confirm=True)

            imagebutton auto "gui/mis_botones/acerca_de_%s.png" xpos 48 ypos 804 focus_mask True action ShowMenu("about") hovered [Play("sound", "audio/sonido/clic.mp3")]

            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
                imagebutton auto "gui/mis_botones/ayuda_%s.png" xpos 48 ypos 849 focus_mask True action ShowMenu("help") hovered [Play("sound", "audio/sonido/clic.mp3")]

            if renpy.variant("pc"):
                imagebutton auto "gui/mis_botones/salir_%s.png" xpos 48 ypos 901 focus_mask True action Quit(confirm=not main_menu) hovered [Play("sound", "audio/sonido/clic.mp3")]
        ...
        vbox:
            ...
            if main_menu:
                ...
                textbutton _("Juego nuevo") action Start()
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Sí") action yes_action hovered [Play("sound", "audio/sonido/clic.mp3")]
                textbutton _("No") action no_action hovered [Play("sound", "audio/sonido/clic.mp3")]
