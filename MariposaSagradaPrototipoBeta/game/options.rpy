...
define config.name = _("Mariposa Sagrada")
...
define gui.about = _p(""" Historieta animada-interactiva que muestra la ruta y
los desafíos naturales y no naturales que enfrenta la Mariposa Monarca para
llegar a su destino; con el fin de promover la conciencia en la conservación del
hábitat de este insecto.
""")
...
define build.name = "MariposaSagradaPrototipoBeta"
...
define config.save_directory = "MariposaSagradaPrueba-1652852629"
